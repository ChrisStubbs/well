System.register(['angular2/core', 'angular2/http', 'rxjs/Observable', '../shared/globalSettings'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ResolvedDeliveryService = (function () {
                function ResolvedDeliveryService(http, globalSettingsService) {
                    this.http = http;
                    this.globalSettingsService = globalSettingsService;
                }
                ResolvedDeliveryService.prototype.getResolvedDeliveries = function () {
                    return this.http.get(this.globalSettingsService.globalSettings.apiUrl + 'deliveries/resolved')
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                ResolvedDeliveryService.prototype.handleError = function (error) {
                    console.log(error);
                    return Observable_1.Observable.throw(error.json().error || 'Server error');
                };
                ResolvedDeliveryService = __decorate([
                    core_1.Injectable(), 
            ...
            exports_1("ResolvedDeliveryService", ResolvedDeliveryService);
        }
    }
});
