System.register(['@angular/core', '@angular/router-deprecated', './widgetstats-service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, widgetstats_service_1;
