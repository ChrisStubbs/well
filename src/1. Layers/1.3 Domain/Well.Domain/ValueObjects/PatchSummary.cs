namespace PH.Well.Domain.ValueObjects
{
    ...
    public class PatchSummary
    {
        ...
        public string ManuallyCompleteMessage => NoOfJobs > 0
            ...
            : "No jobs that can be manually completed have been selected. The Job must be assigned to you and have a status of 'Invoiced' or be marked as 'Completed on Paper'";
