...
USING	(VALUES	(1,'DEL-TOB','Tobacco','deployment',GETDATE(),'deployment',GETDATE()),
				...
				(7,'UPL-SAN','Uplift – Sandwiches','deployment',GETDATE(),'deployment',GETDATE()),
				(8,'UPL-GLO','Uplift – Global','deployment',GETDATE(),'deployment',GETDATE()),
				(9,'UPL-ASS','Uplift – Scheduled Asset Uplift','deployment',GETDATE(),'deployment',GETDATE()),
