...
Scenario: A user can view Clean Delivery Information
	...
	| 001   | 1    | 94294343 | 49214.152 | CSG - must be CF van |
	| 001   | 1    | 92545470  | 2874.033  | CSG - must be CF van |
	| 001   | 2    | 92545470  | 2874.033  | RVS SHOP             |
...
Scenario: A user can filter Clean Delivery information
	...
	Then the following clean deliveries will be displayed
	| Route | Drop | InvoiceNo  | Account   | AccountName          |
	| 006   | 1   | 91156028 | 43362.048 | WB - SHOP            |
	| 006   | 1   | 92544765  | 2874.033  | WB - SHOP            |
	| 006   | 2   | 94295479 | 54107.000 | WB - SHELL FORECOURT |
	| 006   | 2   | 94294985 | 54107.000 | WB - SHELL FORECOURT |	
	...
	Then the following clean deliveries will be displayed
	| Route | Drop | InvoiceNo  | Account   | AccountName   | 
	| 011   | 5   | 92545853 | 28398.080 | TESCO EXPRESS | 
...
Scenario: A user can view Clean Delivery Information and sort on updated date
	...
	| 001   | 1   | 94294343 | 49214.152 | CSG - must be CF van | Sep 7, 2016, 1:27:17 PM |
	| 001   | 1   | 92545470  | 2874.033  | CSG - must be CF van | Sep 7, 2016, 1:27:16 PM |
	| 001   | 2   | 92545470  | 2874.033  | RVS SHOP             | Sep 7, 2016, 1:27:15 PM |
