...
Scenario: Add short qty and damages to clean delivery
	...
	| Product: 50035 - Ind Potato Gratin 400g. Short Qty changed from 0 to 5. Damages added Reason - Picking Error, Source - Customer, Action - Credit - 2. | DeliveryLineUpdate | 949214.152 | 49214.152 - CSG - must be CF van | 07/01/2016   |
