...
namespace PH.Well.UnitTests.ACL.AdamListener
{
    ...
    public class AdamFileMonitorServiceTests
    {
        ...
        public void GetDateStampFromFileTest()
        {
            ...
            var routeFileInfo = new AdamFileMonitorService.ImportFileInfo(routeFileName, routeFileName,
            ...
            var orderFileInfo = new AdamFileMonitorService.ImportFileInfo(orderFileName, orderFileName,
            ...
            var epodFileInfo = new AdamFileMonitorService.ImportFileInfo(epodFileName, epodFileName,
