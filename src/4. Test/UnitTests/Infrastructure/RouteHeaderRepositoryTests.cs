...
namespace PH.Well.UnitTests.Infrastructure
{
    ...
    public class RouteHeaderRepositoryTests
    {
        ...
        public class TheGetRouteHeadersMethod : RouteHeaderRepositoryTests
        {
            ...
            {
                dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RouteHeadersGetWithFullObjectGraph)).Returns(this.dapperProxy.Object);
                dapperProxy.Setup(x => x.AddParameter("UserName", UserName, DbType.String, null)).Returns(this.dapperProxy.Object);
                dapperProxy.Setup(x => x.QueryMultiple(It.IsAny<Func<SqlMapper.GridReader, IEnumerable<RouteHeader>>>())).Returns(new List<RouteHeader>());
                repository.GetRouteHeaders();

                dapperProxy.Verify(x => x.WithStoredProcedure(StoredProcedures.RouteHeadersGetWithFullObjectGraph), Times.Once);
                dapperProxy.Verify(x => x.AddParameter("UserName", UserName, DbType.String, null), Times.Once);
                dapperProxy.Verify(x => x.QueryMultiple(It.IsAny<Func<SqlMapper.GridReader, IEnumerable<RouteHeader>>>()));
            }
            ...
            ////        dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RouteHeadersGet)).Returns(this.dapperProxy.Object);
            ////        dapperProxy.Setup(x => x.AddParameter("UserName", UserName, DbType.String, null)). Returns(this.dapperProxy.Object);
            ...
            public class TheGetRouteHeaderByIdMethod : RouteHeaderRepositoryTests
            {
                ...
                {
                    var routeId = 1;
                    dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RouteHeaderGetById)).Returns(this.dapperProxy.Object);
            ...
            public class TheGetRoutesByIdMethod : RouteHeaderRepositoryTests
            {
                ...
                {
                    var routesId = 1;
                    dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RoutesGetById)).Returns(this.dapperProxy.Object);
            ...
            public class TheGetByFilenameMethod : RouteHeaderRepositoryTests
            {
                ...
                public void ShouldCallTheStoredProcedureCorrectly()
                {
                    ...
                    dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RoutesCheckDuplicate)).Returns(this.dapperProxy.Object);
            ...
            public class TheGetRouteHeaderByRouteNumberAndDateMethod : RouteHeaderRepositoryTests
            {
                ...
                public void ShouldCallTheStoredProcedureCorrectly()
                {
                    ...
                    dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RouteHeaderGetByRouteNumberAndDate)).Returns(this.dapperProxy.Object);
                    ...
                    dapperProxy.Verify(x => x.WithStoredProcedure(StoredProcedures.RouteHeaderGetByRouteNumberAndDate), Times.Once);
            ...
            public class TheGetRouteAttributeExceptionMethod : RouteHeaderRepositoryTests
            {
                ...
                public void ShouldCallTheStoredProcedureCorrectly()
                {
                    dapperProxy.Setup(x => x.WithStoredProcedure(StoredProcedures.RouteAttributesGetExceptions)).Returns(this.dapperProxy.Object);
                    ...
                    dapperProxy.Verify(x => x.WithStoredProcedure(StoredProcedures.RouteAttributesGetExceptions), Times.Once);
