    ...
    public class ExceptionEventServiceTests
    {
        ...
        public class TheBulkCreditMethod : ExceptionEventServiceTests
        {
            ...
            public void ShouldBulkCredit()
            {
                ...
                this.adamRepository.Setup(x => x.Credit(creditEvents[0], It.IsAny<AdamSettings>()))
                    .Returns(AdamResponse.Success);

                this.adamRepository.Setup(x => x.Credit(creditEvents[1], It.IsAny<AdamSettings>()))
                    .Returns(AdamResponse.Success);
                ...
                this.adamRepository.Verify(x => x.Credit(creditEvents[1], It.IsAny<AdamSettings>()), Times.Once);
